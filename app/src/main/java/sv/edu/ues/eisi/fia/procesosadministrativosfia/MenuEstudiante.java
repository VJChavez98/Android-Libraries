...
public class MenuEstudiante extends ListActivity {
    ...
    String [] menu;
    String [] activities;
    /*String [] menu = {"Repetido", "Diferido", "Local", "Evaluacion",  "Inscripcion a Primera Revision", "Primera Revision", "Solicitud Revision", "Lista de Revisiones"};
    String [] activities = {"Repetido_menu", "Diferido_menu", "Local_menu", "Evaluacion_menu", "PeriodoInscripcionRevision_menu", "PrimeraRevision_menu", "SolicitudRevision_menu", "ListaPerInsRevActivity"};*/
