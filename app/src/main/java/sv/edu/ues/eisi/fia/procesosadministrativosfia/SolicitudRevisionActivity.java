...
public class SolicitudRevisionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(objetoEnviado!=null){
            ...
            periodo= (PeriodoInscripcionRevision) objetoEnviado.getSerializable("periodo");

            codtiporevision.setText(periodo.getTipoRevision().toString());
            codasignatura.setText(periodo.getCodAsignatura().toString());
            codtipoevaluacion.setText(periodo.getCodTipoEval().toString());
            numeroevaluacion.setText(Integer.toString(periodo.getNumeroEval()));
            codciclo.setText(periodo.getCodCiclo());
